...
struct OverridableHttpConfigParams {
  OverridableHttpConfigParams()
    : maintain_pristine_host_hdr(1), chunking_enabled(1), negative_caching_enabled(0), negative_revalidating_enabled(0),
      ...
      default_buffer_size_index(8), default_buffer_water_mark(32768), simple_retry_enabled(0), dead_server_retry_enabled(0),
...
inline HttpConfigParams::HttpConfigParams()
  : proxy_hostname(NULL), proxy_hostname_len(0), server_max_connections(0), origin_min_keep_alive_connections(0),
    ...
    session_auth_cache_keep_alive_enabled(1), accept_no_activity_timeout(120), parent_connect_attempts(4),
    per_parent_connect_attempts(2), parent_connect_timeout(30), anonymize_other_header_list(NULL), enable_http_stats(1),
    icp_enabled(0), stale_icp_enabled(0), cache_vary_default_text(NULL), cache_vary_default_images(NULL),
    ...
    cache_open_write_fail_action(0), disallow_post_100_continue(0), parser_allow_non_http(1), autoconf_port(0),
