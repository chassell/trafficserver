...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_PARENT_PROXY_PER_PARENT_CONNECT_ATTEMPTS = TS_CONFIG_HTTP_PARENT_PROXY_PER_PARENT_CONNECT_ATTEMPTS,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_LUA_CONFIG_HTTP_PARENT_PROXY_PER_PARENT_CONNECT_ATTEMPTS),
