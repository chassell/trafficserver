...
extern const GetObjFxn<uint64_t*>        thread_allocated_ptr;
extern const GetObjFxn<uint64_t*>        thread_deallocated_ptr;
...
extern const GetObjFxn<bool>             global_prof_active;
extern const SetObjFxn<bool>             set_global_prof_active;
}
