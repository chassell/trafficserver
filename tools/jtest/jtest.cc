...
static const ArgumentDescription argument_descriptions[] = {
  ...
  {"proxy_host", 'P', "Proxy Host", "S80", { .u_buffer=proxy_host }, "JTEST_PROXY_HOST", nullptr},
  {"server_port", 's', "Server Port (0:auto select)", "I", server_port, "JTEST_SERVER_PORT", nullptr},
  {"server_host", 'S', "Server Host (null:localhost)", "S80", { .u_buffer=local_host }, "JTEST_SERVER_HOST", nullptr},
  ...
  {"hitrate", 'z', "Hit Rate", "D", { .u_double=hitrate }, "JTEST_HITRATE", nullptr},
  ...
  {"ftp_mdtm_err_rate", ' ', "FTP MDTM 550 Error Rate", "D", { .u_double=ftp_mdtm_err_rate }, "JTEST_FTP_MDTM_ERR_RATE", nullptr},
  ...
  {"urls", 'u', "URLs from File", "S256", { .u_buffer=urls_file }, "JTEST_URLS", nullptr},
  {"urlsdump", 'U', "URLs to File", "S256", { .u_buffer=urlsdump_file }, "JTEST_URLS_DUMP", nullptr},
  ...
  {"url_hash_filename", 'Q', "URL Hash Table Filename", "S256", { .u_buffer=url_hash_filename }, "JTEST_URL_HASH_FILENAME", nullptr},
  ...
  {"ims_rate", 'I', "IMS Not-Changed Rate", "D", { .u_double=ims_rate }, "JTEST_IMS_RATE", nullptr},
  {"client_abort_rate", 'g', "Client Abort Rate", "D", { .u_double=client_abort_rate }, "JTEST_CLIENT_ABORT_RATE", nullptr},
  {"server_abort_rate", 'G', "Server Abort Rate", "D", { .u_double=server_abort_rate }, "JTEST_SERVER_ABORT_RATE", nullptr},
  ...
  {"reload_rate", 'W', "Reload Rate", "D", { .u_double=reload_rate }, "JTEST_RELOAD_RATE", nullptr},
  ...
  {"zipf", '8', "Use a Zipf distribution with this alpha (say 1.2)", "D", { .u_double=zipf }, "JTEST_ZIPF", nullptr},
  {"evo_rate", '9', "Evolving Hotset Rate (evolutions/hour)", "D", { .u_double=evo_rate }, "JTEST_EVOLVING_HOTSET_RATE", nullptr},
...
build_request(int sock)
{
  ...
  *cookie = 0;
  ...
  switch (hostrequest) {
  case 0:
    make_nohost_request(sock, dr, evo_str, extension, eheaders, rbuf, cookie);
    break;
  case 1:
    make_host1_request(sock, dr, evo_str, extension, eheaders, cookie);
    break;
  case 2:
    make_host2_request(sock, dr, evo_str, extension, eheaders, cookie);
    break;
  default:
